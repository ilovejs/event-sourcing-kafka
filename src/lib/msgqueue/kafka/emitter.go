...
import (
	...
	// Don't use below since package file contains:
	// 		bitbucket.org/minamartinteam/myevents
	"github.com/ilovejs/event-sourcing-kafka/src/lib/helper/kafka"
	"github.com/ilovejs/event-sourcing-kafka/src/lib/msgqueue"

	//"../../helper/kafka"
	// import other go files in package: msgqueue
	//"../../msgqueue"
)
